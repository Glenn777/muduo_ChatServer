...
vector<Group> GroupModel::queryGroups(int userid)
{
    ...
    {
        // grouprole是在GroupUser表中
        //sprintf(sql, "select a.id, a.name, a.state, a.grouprole from User a inner join GroupUser b on a.id = b.userid where b.groupid = %d", group.getId());
